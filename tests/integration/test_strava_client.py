...
@pytest.mark.asyncio
@respx.mock
async def test_fetch_feed_json_success() -> None:
    feed_data = {"entries": [{"id": "12345", "sport_type": "Run"}]}
...
@pytest.mark.asyncio
@respx.mock
async def test_fetch_feed_falls_back_to_html() -> None:
    html = _load("feed_sample.html")
